...
\thesissetup{
    ...
    author      = Vojtěch Balek,
    gender      = f,
    advisor     = {doc. Mgr. Radek Pelánek, Ph.D.},
    title       = {Automatic Detection of Attention-Worthy Educational Items},
    TeXtitle    = {Automatic Detection of Attention-Worthy Educational Items},
...
This is a bullet list. Unlike number
ffmpeg-2025-10-12-git-0bc54cddb1-essentials_build\ffmpeg-2025-10-12-git-0bc54cddb1-essentials_build\bin\ffmpeg.exe\'.

ed lists, bulleted lists
